...
<img width="2534" height="1228" alt="image" src="https://github.com/user-attachments/assets/48530a4a-7dd5-47a1-98a3-1280877627db" />
...
### 3. 创建 Pages 项目
1. 在 Cloudflare 控制台，进入 **Workers & Pages** -> **Overview**。
...
## ⚠️ 注意事项
* **图片存储**：本面板不提供图片上传存储服务（为了保持轻量）。添加图标或背景时，请使用外部图床链接（如 GitHub Raw, Imgur 等）或 Base64 编码。
